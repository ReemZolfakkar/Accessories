      ...
      <div className="product-item">
        <Link to={`/ProductDetails/${props.id}`}>
          <div className="product-item-header">
            ...
            <button className="product-item-review">Quick review</button>
          </div>
        </Link>
        ...
        <span className="product-item-price">{props.Product.price}.00 EGP</span>
      </div>
    </>
  );
}
