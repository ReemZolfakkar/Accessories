    ...
    <div className="row Checkout">
      ...
      <div className="col-4 Chechout__form">
        ...
        <form onSubmit={handleSubmit}>
          <div className="Chechout__form__items">
            ...
            ></input>
            <p className="Chechout__form__error">{formsErrors.CardNumber}</p>
          </div>
          <div className="Chechout__form__items">
            ...
            <input
              ...
              onChange={handleInput}
            ></input>
            <p className="Chechout__form__error">{formsErrors.CardHolder}</p>
          </div>
          <div className="Chechout__form__items">
